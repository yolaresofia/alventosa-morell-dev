...
export const about = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Social Media',
      type: 'object',
      fields: [defineField({name: 'instagram', title: 'Instagram', type: 'link'})],
    }),
    defineField({
      name: 'team',
      title: 'Team',
    ...
    defineField({
      ...
      fields: [
        defineField({
          name: 'titleTranslations',
          title: 'Títol de la Secció (Premis)',
          type: 'object',
          fields: [
            defineField({name: 'ca', title: 'Català', type: 'string'}),
            defineField({name: 'es', title: 'Espanyol', type: 'string'}),
            defineField({name: 'en', title: 'Anglès', type: 'string'}),
          ],
        }),
        defineField({
          name: 'list',
          title: 'Llista de Premis',
          type: 'array',
          of: [
            defineField({
              name: 'award',
              title: 'Premi',
              type: 'object',
              fields: [defineField({name: 'title', title: 'Títol', type: 'string'})],
            }),
          ],
        }),
      ],
