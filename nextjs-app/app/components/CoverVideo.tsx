...
import { CoverVideo as CoverVideoType } from "@/sanity.types";
...
function getVimeoEmbedUrl(vimeoUrl: string): string | null {
  try {
    ...
    return videoId ? `https://player.vimeo.com/video/${videoId}?autoplay=1&loop=1&muted=1&background=1&title=0&byline=0&portrait=0` : null;
  } catch {
    return null;
  }
}
